...
import type { Genre, MediaItem, Movie, TMDBConfig, TMDBResponse } from "$lib/types/tmdb";
...
// Get Movie by ID
export async function getMovieById(movieId: string): Promise<TMDBResponse<Movie> | null> {
